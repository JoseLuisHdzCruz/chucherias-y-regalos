                    ...
                    <div className="row">
                        <div className="col-12 col-sm-6">
                            ...
                            <div className="col-12 product-image-thumbs">
                                ...
                                <div className="product-image-thumb"><img src="/images/icono-producto.png" alt="Product Image" /></div>
                                <div className="product-image-thumb active"><img src="/images/icono-producto.png" alt="Product Image" /></div>
                                <div className="product-image-thumb"><img src="/images/icono-producto.png" alt="Product Image" /></div>
                                <div className="product-image-thumb"><img src="/images/icono-producto.png" alt="Product Image" /></div>
                            </div>
                        </div>
                        <div className="col-12 col-sm-6">
                            ...
                            <h4 className="mt-3">Tamaño <small>Porfavor seleccione uno</small></h4>
                            <div className="btn-group btn-group-toggle" data-toggle="buttons">
                                <label className="btn btn-default text-center">
